...
export const zh: Record<TKey, string> = {
  ...
  "models.smartRoutingApplying": "正在应用…",
  "models.smartRoutingApplied": "已应用 {mode} 智能路由。",
  "models.smartRoutingFailed": "无法应用智能路由。",
  "models.smartRouting_intelligence": "智能",
  "models.smartRouting_balance": "均衡",
  "models.smartRouting_cost": "成本",
